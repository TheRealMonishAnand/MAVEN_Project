...
class LoginAutomationTest {
    ...
    static void setup() {
        ...
        System.setProperty("webdriver.gecko.driver", "C:\\Users\\monis\\Downloads\\geckodriver-v0.35.0-win64\\geckodriver.exe");
    ...
    void testWelcomeMessage() {
        ...
        String result = app.welcomeMessage("Monish");

        // Validating the result
        assertEquals("Hello, Monish!", result, "The welcome message should be correct.");
    }
